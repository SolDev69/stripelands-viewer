...
public class MixinServerPlayNetworkHandler {
    @ModifyConstant(constant = @Constant(doubleValue = 3.0E7, ordinal = 0), method = "onPlayerMove")
    private static double modifyIllegalPosKick(double original) {
        return 2.0E9D;
    }
    @ModifyConstant(constant = @Constant(doubleValue = 3.0E7, ordinal = 1), method = "onPlayerMove")
